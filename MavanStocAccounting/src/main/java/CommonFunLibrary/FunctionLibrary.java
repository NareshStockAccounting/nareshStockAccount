...
wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(locatorValue)));	
	...
	public static void captureData(WebDriver driver,String locatorType,String locatorValue) throws Throwable
	{
		...
		FileWriter fw=new FileWriter("D:\\StockAccountingVasu\\MavanStocAccounting\\CaptureData\\Data.txt");
	...
	public static void pageDown(WebDriver driver)
	{
	 ...
	 public static void tableValidation(WebDriver driver,String colNum) throws Throwable
	 {
		...
		}else
		{
		 ...
		 public static void tableValidation1(WebDriver driver) throws Throwable
		 {
			 
			
			
			if(driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("categorySaerch.path"))).isDisplayed())
			{
				driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("categorySearch.panel"))).clear();
				driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("categorySearch.panel"))).sendKeys("nari");
				driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("categorySearch.btn"))).click();
			}else
			{
	 ...
	 public static String genarateDate() throws Throwable
	 {
		Date dateFormat= new Date();
		SimpleDateFormat dfm= new SimpleDateFormat("YYYY_MM_dd_mm_ss");
		return dfm.format(dateFormat);
		
	}
	 public static void mouseClick(WebDriver driver){
		 Actions ac = new Actions(driver);
		 ac.moveToElement(driver.findElement(By.xpath("//*[@id='mi_a_stock_items']"))).build().perform();
		 ac.moveToElement(driver.findElement(By.xpath("//*[@id='mi_a_stock_categories']"))).click().build().perform();
